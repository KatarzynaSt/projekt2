...
void Samochod::jazda()
{
	...
	cout << " Poprzednia komenda - speed, slow lub const - konczy sie, gdy wpiszesz nastepna, dowolna komende." << endl;
	...
	while (moje_parametry.get_pozostala_ilosc_oleju()>0 && moje_parametry.get_pozostala_ilosc_paliwa()>0 && moje_parametry.get_obroty() != 0)
	{
		...
		{
			cout << " Twoj samochod nie umie takich rzeczy robic :/" << endl;
		}
	}
